class RetailersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @retailer.save
        format.html { redirect_to new_retailer_path, notice: 'Retailer was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @retailer.update(retailer_params)
        format.html { redirect_to brands_path, notice: 'Retailer was successfully updated.' }
  ...
  private
    ...
    def retailer_params
      params.require(:retailer).permit(:name, :url, :what_i_say, :what_they_say, :cottage_industry, :avantlink_searchable, internal_category_ids: [])
    end
end
